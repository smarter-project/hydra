...
: ${DEFAULT_DIR_IMAGE:="$(pwd)/image-SME"}
...
: ${INSTALL_ADDITIONAL_DEBS:="https://ftp.debian.org/debian/pool/main/l/linux/linux-image-6.16.12+deb14+1-arm64-unsigned_6.16.12-2_arm64.deb"}
